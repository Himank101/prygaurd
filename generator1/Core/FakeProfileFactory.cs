...
using generator1.Model;
using generator1.Helpers;
    ...
    public static List<ScreenSize> ScreenSizes { get; } = new List<ScreenSize>()
{
    ...
    public static List<int> CpuConcurrency { get; } = new List<int>() { 2, 4, 6, 8, 10, 12, 16, 24, 32 };
    public static List<int> MemoryAvailable { get; } = new List<int>() { 2, 4, 6, 8, 16, 32 };
